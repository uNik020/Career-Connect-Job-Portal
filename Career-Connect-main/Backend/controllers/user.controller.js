...
export const register = async (req, res) => {
  try {
    ...
    try {
      ...
      return res.status(500).json({ message: "Error uploading to Cloudinary", success: false });
    }
    ...
    await newUser .save();
    return res.status(201).json({ message: `Account created successfully ${fullname}`, success: true });
  } catch (error) {
